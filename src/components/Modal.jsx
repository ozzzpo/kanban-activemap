  ...
  return (
    ...
    >
      <div
        ...
        style={{ boxShadow: `4px 4px 4px #${color}50` }}
        className='modal_content'
      >
        <div className='modal_inform'>
          <div className='modal_header'>
            <p>{task.title}</p>
            <p className='modal_close' onClick={() => isActive(!active)}>
              X
            </p>
          </div>
                      ...
                      <div className='modal_okr'>
                        <div className='modal_pp'>
                          <img
                            ...
                            src={`https://team1.activemap.ru/rest/tasks/${task.id}/photos/${el.num}?token=${token}`}
                          />
                        </div>
